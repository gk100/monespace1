...
<body>
    ...
    <nav class="navbar navbar-transparent navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://localhost:8080/monespace/"><b><i>Mon Espace!</i></b></a>
            </div>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <ol class="carousel-indicators">
            <li data-target="resources/img/bg-Mumbai1.jpg" data-slide-to="0" class="active"></li>
            ...
            <li data-target="resources/img/bg-Banguluru.jpg" data-slide-to="3"></li>
